...
function AiAssistant({ periodLabel, total, transactionCount, categoryTotals, open, onClose }) {
  ...
  return (
    <div
      className={`fixed bottom-5 right-5 w-80 bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-emerald-100 dark:border-gray-700 z-50 flex flex-col overflow-hidden transition-all duration-300 ease-out ${
        open
