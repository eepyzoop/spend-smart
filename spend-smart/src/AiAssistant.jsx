  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-5 left-5 w-12 h-12 bg-emerald-700 hover:bg-emerald-600 text-white rounded-full shadow-xl flex items-center justify-center text-xl transition-all duration-200 z-50"
        title="AI Assistant"
      >
        ✨
      </button>
      ...
      <div
        className={`fixed bottom-20 left-5 w-80 bg-white rounded-2xl shadow-2xl border border-emerald-100 z-50 flex flex-col overflow-hidden transition-all duration-300 ease-out ${
          aiOpen
            ? 'opacity-100 translate-y-0 pointer-events-auto'
            : 'opacity-0 translate-y-4 pointer-events-none'
        }`}
      >
        <div className="bg-emerald-700 text-white px-4 py-3 flex justify-between items-center flex-shrink-0">
        ...
        <div className="overflow-y-auto p-4 space-y-3" style={{ maxHeight: '280px' }}>
              ...
              <div className="space-y-2">
                {EXAMPLE_PROMPTS.map((prompt) => (
                  <button
                    ...
                    className="block w-full text-left text-sm text-gray-500 bg-gray-50 hover:bg-emerald-50 hover:text-emerald-700 px-3 py-2 rounded-lg transition-colors border border-gray-100"
                  >
                    {prompt}
                  </button>
                ))}
          ...
          {aiLoading && (
            <div className="bg-gray-100 text-gray-400 text-sm px-3 py-2 rounded-xl w-14 animate-pulse">
              ...
            </div>
          )}
        ...
        <div className="border-t border-gray-100 p-3 flex gap-2 flex-shrink-0">
          ...
          <button
            ...
            className="bg-emerald-600 hover:bg-emerald-700 text-white px-3 py-2 rounded-lg text-sm font-bold transition-colors disabled:opacity-40"
          >
            →
          </button>
        </div>
